...
repo_path = '.'  # Set to current directory

try:
    repo = git.Repo(repo_path)
except git.InvalidGitRepositoryError:
    print(f"The directory {repo_path} is not a valid Git repository. Exiting.")
    exit(1)

print(f"You are working in the {os.path.abspath(repo_path)} repository.")
