...
def main():
    ...
    while True:
        ...
        print(f"{OUTPUT_TEXT}4. Tag a new version{RESET_TEXT}")
        print(f"{OUTPUT_TEXT}5. Exit{RESET_TEXT}")
        ...
        if user_choice == '1':
            ...
            print(f"{OUTPUT_TEXT}Current version: {ANSWER_TEXT}{current_version}{RESET_TEXT}")
            print(f"{OUTPUT_TEXT}1. Increment major version{RESET_TEXT}")
            print(f"{OUTPUT_TEXT}2. Increment minor version{RESET_TEXT}")
            print(f"{OUTPUT_TEXT}3. Increment patch version{RESET_TEXT}")
            ...
            print(f"{ERROR_TEXT}Invalid choice. Please enter a number between 1 and 5.{RESET_TEXT}")
